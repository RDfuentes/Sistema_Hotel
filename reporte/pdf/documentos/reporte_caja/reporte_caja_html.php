...
.tr{
    style="color: black; background-color: #eaeaea;"
}
.contenido{
...
th {     font-size: 13px;     font-weight: normal;     padding: 8px;     background: #d7d7d7;
...
<table   >
            ...
            <tr class="tr" style="width: 100%; ">
                        ...
                        <th style="width: 20%;">Q <?php echo number_format($caja->monto_apertura,2,'.',','); ?></th>
            </tr>
            <tr class="tr" style="width: 100%; ">
                        <th style="width: 8%;">MONTO CIERRE</th> 
                        <th style="width: 20%;">Q <?php echo number_format($caja->monto_cierre,2,'.',','); ?></th>
            </tr>
            <tr>
                <th></th>
                <th></th>
            ...
            <tr class="tr" style="width: 100%; ">
                        ...
                        <th style="width: 20%;"><b>Q  <?php echo number_format($caja->monto_cierre+$caja->monto_apertura,2,'.',','); ?></b></th>
            </tr>
