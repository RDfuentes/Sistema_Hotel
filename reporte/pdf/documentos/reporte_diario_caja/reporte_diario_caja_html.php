...
<page backtop="15mm" backbottom="28mm" backleft="5mm" backright="5mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; border: solid 0px #7f8c8d; text-align: center; font-size: 10pt;padding:1mm; padding-top: 0mm !important;">
        ...
        <tr>
            ...
            <td  style="width: 40%; text-align: center;border:black 1px solid;"><br><b style="text-decoration:underline; font-family:Arial, Helvetica, sans-serif;" >FECHA: <?php echo $hoy; ?><BR><BR> Alquiler de habitación: <?php echo 'Q '.number_format($subtotal4,2,'.',',') ?><BR><BR> Servicio de habitación: <?php echo number_format($subtotal3,2,'.',','); ?><BR><BR> Gastos: <?php echo 'Q '.number_format($subtotal5,2,'.',','); ?><BR><BR> TOTAL: <?php echo 'Q '.number_format($subtotal3+$subtotal4-$subtotal5,2,'.',','); ?></b></td>
...
<table  class="contenido">
                  ...
                  <tr class="tr" style="width: 100%; ">
                        ...
                        <th style="width: 30%;">Dinero dejado</th>
...
<?php $total=$subtotal+$total; ?>
            ...
            <tr class="tr" style="width: 100%; ">
                        ...
                        <th style="width: 30%;float: right !important;">Q  <?php echo number_format($total,2,'.',','); ?> </th>
                        <th style="width: 20%;"></th>
                        <th style="width: 20%;"> </th> 
            </tr>
<?php 
