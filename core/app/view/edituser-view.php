...
return patron.test(te); // 6
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="name" value="<?php echo $user->name;?>" class="form-control" onkeypress="return validar(event)" id="name" placeholder="Nombre">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="lastname" value="<?php echo $user->lastname;?>" required class="form-control" id="lastname" placeholder="Apellido" onkeypress="return validar(event)">
    </div>
  </div>
