...
<div class="row">
 ...
 <section class="content-header">
      <h1 >
        <span class="fa fa-hotel"></span> PROCESO DE VENTA DE PRODUCTO</h1>
      <ol class="breadcrumb">
...
<form class="form-horizontal" method="post" id="addproduct" action="index.php?view=addventa" role="form">
	...
	<section>
		...
		<div class="col-md-6">
            ...
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>Costo habitación</b> <a class="pull-right"><b>Q  <?php echo number_format($habitacion->getHabitacion()->precio,2,'.',','); ?></b></a>
                </li>
              </ul> 
            </div>
            <!-- /.box-body -->
        ...
        <div class="col-md-12">
              ...
              <div class="box-footer" style="background-color: #343a40;">
              	<div class="col-md-2">
