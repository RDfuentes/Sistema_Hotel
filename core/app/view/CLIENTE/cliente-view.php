                ...
                <div class="col-md-offset-1 col-md-10">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control col-md-8" value="<?php echo $cliente->apellido; ?>" name="apellido" required placeholder="Ingrese Apellidos">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control col-md-8" value="<?php echo $cliente->nacionalidad; ?>" name="nacionalidad" required placeholder="Nacionalidad">
                    </div>
                  </div>
              ...
              <div class="modal-body" style="background-color:#fff !important;">
                ...
                <div class="col-md-offset-1 col-md-10">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Apellidos </span>
                      <input type="text" class="form-control col-md-8" name="apellido" required placeholder="Ingrese Apellidos">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Nacionalidad </span>
                      <input type="text" class="form-control col-md-8" name="nacionalidad" required placeholder="Nacionalidad">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Razón social </span>
                      <input type="text" class="form-control col-md-8" name="razon_social"  required placeholder="Ingrese Razon Social">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"> Dirección </span>
                      <input type="text" class="form-control col-md-8" name="direccion"  required placeholder="Ingrese Dirección">
                    </div>
                  </div>
