...
<div class="row">
 ...
 <section class="content-header">
      <h1 >
        HABITACIONES OCUPADAS PARA REALIZAR VENTA 
      </h1>
      <ol class="breadcrumb">
                   ...
                   <?php foreach($habitaciones as $habitacion):?>
                    ...
                    <div class="col-lg-3 col-xs-6">
                      ...
                      <div class="small-box bg-aqua">
                        ...
                        <div class="icon">
                          <i class="fa fa-hotel" style="color:#e3e3e3;"></i>
                        </div>

                       <a href="index.php?view=proceso_venta&id=<?php echo $habitacion->id; ?>"  data-target="#myModal<?php echo $habitacion->id; ?>" class="small-box-footer">Procesar Venta <i class="fa fa-spinner"></i></a>
