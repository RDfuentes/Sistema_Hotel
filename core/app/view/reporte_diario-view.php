  ...
  <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs" style="background-color: #d2d6de;">
              ...
              <li class="pull-right text-red"><a href="reporte/pdf/documentos/reporte_diario.php" target="_blank" class="text-muted"><i class="fa fa-print"></i> IMPRIMIR PDF</a></li>
              <li class="pull-right text-red"><a onclick="tableToExcel('example1', 'W3C Example Table')" target="_blank" class="text-muted"><i class="fa fa-print"></i> IMPRIMIR EXCEL</a></li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                ...
                if(count($reportediarios)>0){
                  // si hay usuarios
                  ?>
                  <table id="example1" class="table table-bordered table-hover" summary="Code page support in different versions of MS Windows." rules="groups" frame="hsides" border="2"><caption>REPORTE DIARIO</caption>
