  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-3">
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              ...
              <li><a href="#tab_2" data-toggle="tab" class="btn-primary"> <i class="fa fa-filter"></i>NFC</a></li>
    ...
    <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">NÚMERO DE COMPROBANTE FISCAL</h3>

            
            </div>
            <?php 
            $nfc = NcfData::getAllNcf(); 
            if(count($nfc)>0){ 
              $tipo=$nfc->tipo;
              $secuencia=$nfc->secuencia;
              $cantidad=$nfc->cantidad;
              
              $id=$nfc->id; ?>
             
              <form class="form-horizontal" method="post" id="addproduct" action="index.php?view=updatenfc" role="form">
            ...
            <?php }else{
              ...
              $id=0; ?>
               <form class="form-horizontal" method="post" id="addproduct" action="index.php?view=addnfc" role="form">
            <?php }
            ?>
            <!-- /.box-header -->
            <div class="box-body no-padding">
                ...
                <div class="col-md-offset-1 col-md-10">
                  ...
                  <div class="form-group" >
                     <label>Primero 11 caracteres - letras y nros</label>
                    <div class="input-group">
                      <span class="input-group-addon">Serie y tipo de comprobante </span>
                      <input type="text" class="form-control col-md-12" name="tipo" value="<?php if($tipo!='NULL'){ echo $tipo;  } ?>" placeholder="Eje. B01">
                    </div>
                  </div>
                ...
                <div class="col-md-offset-1 col-md-10">
                  ...
                  <div class="form-group">
                    <label>Siguientes 8 caracteres</label>
                    <div class="input-group">
                      <span class="input-group-addon"> Secuencia &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                      <input type="text" class="form-control col-md-12" name="secuencia" value="<?php if($secuencia!='NULL'){ echo $secuencia;  } ?>" placeholder="Eje. 00000005">
                    </div>
                  </div>
                ...
                <div class="col-md-offset-1 col-md-10">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control col-md-12" name="cantidad" value="<?php if($cantidad!='NULL'){ echo $cantidad;  } ?>" placeholder="Eje. 500">
                    </div>
                  </div>
                  ...
                  <div class="box-footer">
                    ...
                    <input type="hidden" name="id_ncf" value="<?php echo $id; ?>">
                    <button type="submit" class="btn btn-primary" >Actualizar número de comprobante fiscal</button>
